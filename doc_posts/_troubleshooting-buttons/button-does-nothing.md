...
Unless you’re triggering the button by pressing it on the SAMMI Panel, it’s possible that your button didn’t work because it isn’t triggering properly. There are two ways to check whether your button triggered:

- Look at the SAMMI Panel to see whether the button shows an animation
...
- Make sure whatever is sending your trigger is connected to SAMMI. You can see this in the bottom left of the main window. Twitch Subs, Channel Points, etc. arrive via Twitch EventSub (indicated by the "Twitch Eventsub" connection indicator).
