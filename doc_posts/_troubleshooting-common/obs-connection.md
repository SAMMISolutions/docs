...
1. Switch to the OBS Websocket 5.0 protocol in SAMMI and make the necessary changes to your Send OBS Request command to reflect the correct OBS Websocket 5.0 protocol syntax and change your OBS Triggers, OR 
