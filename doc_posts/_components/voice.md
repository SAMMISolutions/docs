...
{% include alert.html text="It is highly recommended you go through the steps tp 'Train your computer to better understand you' so that SAMMI Voice can properly detect your voice and accent when used to trigger buttons." type="info" %}
