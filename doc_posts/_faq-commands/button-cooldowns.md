...
{% include alert.html text="Group ID and queues only work for buttons that have NOT been manually triggered from your SAMMI Panel, but rather initiated from an external trigger or Button: Trigger command." type="warning" %} 
