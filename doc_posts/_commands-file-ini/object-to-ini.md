...
{% include alert.html text="The only way to create a nested object is with the command [Parse Array/Object]({{ "/object#objecttoarray" | relative_url }}) or with [File: INI to File](#fileinitoobject)." type="warning" %} 
